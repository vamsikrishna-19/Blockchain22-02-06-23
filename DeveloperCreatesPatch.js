						...
						<div className="row">
							<div className="col-12 col-lg-6 mx-auto">
								<div className="input-group mb-3 me-3 d-flex align-items-end">
									...
									<input type="number" id="RequestNo" className="form-control ms-2" placeholder="Request No" readonly/>
						...
						<div className="row">
							<div className="col-12 col-lg-6 mx-auto">
								<div className="input-group mb-3 me-3 d-flex align-items-center">
									...
									<input type="text" className="form-control ms-2" id="patchplatform" placeholder="Software" readonly />
